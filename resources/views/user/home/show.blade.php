						...
						<div class="single-post row">
							<div class="col-lg-12">
								<div class="feature-img">
									<!-- <img class="img-fluid" src="{{ asset('medicare2/img/blog/feature-img1.jpg') }}" alt=""> -->
									@if($information->logo)
                            <a href="{{ $information->logo->getUrl() }}" target="_blank">
                                <img class="img-fluid" src="{{ $information->logo->getUrl('thumb') }}" width="500px" height="300px">
                            </a>
                            @endif
								</div>
							</div>
							<div class="col-lg-3  col-md-3">
								<div class="blog_info text-right">
									...
									<ul class="blog_meta list">
										...
										<li><a href="#">{{ $information->created_at }}<i class="lnr lnr-calendar-full"></i></a></li>
							...
							<div class="col-lg-9 col-md-9 blog_details">
								<h2>{{ $information->doctor->name}}</h2>
								<p class="excert">
									@foreach($information->diseases as $key => $item)
                            <span class="badge badge-success">{{ $item->name }}</span>
                            @endforeach
								</p>
								<p>
									{!! htmlspecialchars_decode($information->description) !!}
								</p>
