...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('westerndoctors.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group {{ $errors->has('diseases') ? 'has-error' : '' }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('duty_day') ? 'is-invalid' : '' }}" name="duty_day" id="duty_day">
                        ...
                        <option value="{{ $key }}" {{ old('duty_day', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <input class="form-control timepicker {{ $errors->has('duty_time') ? 'is-invalid' : '' }}" type="text" name="duty_time" id="duty_time" value="{{ old('duty_time') }}">
            ...
            <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                ...
                <input type="email" id="email" name="email" class="form-control" value="{{ old('name', isset($doctor) ? $doctor->email : '') }}" required>
                @if($errors->has('phone'))
                <p class="help-block">
                    {{ $errors->first('email') }}
                </p>
